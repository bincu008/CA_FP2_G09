...
GROUP_ID = "G09"
MODEL_ID = 8
CORES_ASSIGNED = list(range(55, 63))  # Cores 55 to 62 (8 cores)

# Extracted directly from workload_config.json for Model 8
ARCH = [433, 1415, 2767, 2962, 729, 16]

# --- Global Tensor Tracking ---
INPUT_OFFSET = 1992  # (1865 + 127)
OUTPUT_OFFSET = 91   # (79 + 12)
...
def generate_model8_instructions():
