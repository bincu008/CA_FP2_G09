...
GROUP_ID = "G09"
MODEL_ID = 9
CORES_ASSIGNED = [63]  # Core 63 (1 core)

# Extracted directly from workload_config.json for Model 9
ARCH = [374, 825, 15]

# --- Global Tensor Tracking ---
INPUT_OFFSET = 2425  # (1992 + 433)
OUTPUT_OFFSET = 107  # (91 + 16)
...
def generate_model9_instructions():
    ...
    # ==========================================
    # LAYER 1: ROW SPLIT -> GATHER -> SOFTMAX
    # ==========================================
    in_chunks = out_chunks
    L = 1
    out_len = ARCH[L+1] # 15 Classes
