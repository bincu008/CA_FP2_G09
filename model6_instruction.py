...
GROUP_ID = "G09"
MODEL_ID = 6
CORES_ASSIGNED = list(range(39, 46))  # Cores 39 to 45 (7 cores)

# Extracted directly from workload_config.json for Model 6
ARCH = [184, 1949, 3179, 2130, 19]

# --- Global Tensor Tracking ---
INPUT_OFFSET = 1681  # (440 + 297 + 93 + 350 + 435 + 66)
OUTPUT_OFFSET = 60   # (9 + 13 + 10 + 11 + 7 + 10)
...
def generate_model6_instructions():
