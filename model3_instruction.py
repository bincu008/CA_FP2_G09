...
GROUP_ID = "G09"
MODEL_ID = 3
CORES_ASSIGNED = list(range(10, 25))  # Cores 10 to 24 (15 cores)

# Extracted directly from workload_config.json for Model 3
ARCH = [350, 3619, 2119, 2830, 498, 3402, 2818, 11]

# --- Global Tensor Tracking ---
INPUT_OFFSET = 830  # (440 + 297 + 93)
OUTPUT_OFFSET = 32  # (9 + 13 + 10)
...
def generate_model3_instructions():
    ...
    # ==========================================
    # LAYERS 1 to 5: ROW SPLIT (Reduce-Scatter)
    # ==========================================
    ...
    # ==========================================
    # LAYER 6: ROW SPLIT -> GATHER -> SOFTMAX
    # ==========================================
    L = 6
    out_len = ARCH[L+1] # 11 Classes
    out_chunks = split_dim(out_len, len(CORES_ASSIGNED))
    offsets = [sum(out_chunks[:j]) for j in range(len(CORES_ASSIGNED))]
