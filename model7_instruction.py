...
GROUP_ID = "G09"
MODEL_ID = 7
CORES_ASSIGNED = list(range(46, 55))  # Cores 46 to 54 (9 cores)

# Extracted directly from workload_config.json for Model 7
ARCH = [127, 2652, 1099, 1434, 3623, 1655, 12]

# --- Global Tensor Tracking ---
INPUT_OFFSET = 1865  # (1681 + 184)
OUTPUT_OFFSET = 79   # (60 + 19)
...
def generate_model7_instructions():
    ...
    # ==========================================
    # LAYERS 1 to 4: ROW SPLIT (Reduce-Scatter)
    # ==========================================
    ...
    # ==========================================
    # LAYER 5: ROW SPLIT -> GATHER -> SOFTMAX
    # ==========================================
    L = 5
    out_len = ARCH[L+1] # 12 Classes
    out_chunks = split_dim(out_len, len(CORES_ASSIGNED))
    offsets = [sum(out_chunks[:j]) for j in range(len(CORES_ASSIGNED))]
