...
GROUP_ID = "G09"
MODEL_ID = 4
CORES_ASSIGNED = list(range(25, 33))  # Cores 25 to 32 (8 cores)

# Extracted directly from workload_config.json for Model 4
ARCH = [435, 1547, 2669, 1492, 3703, 7]

# --- Global Tensor Tracking ---
INPUT_OFFSET = 1180  # (440 + 297 + 93 + 350)
OUTPUT_OFFSET = 43   # (9 + 13 + 10 + 11)
...
def generate_model4_instructions():
